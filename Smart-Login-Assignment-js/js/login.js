...
function loginUser()
{
    if(checkEmail() == true & checkPassword() == true)
    {
        ...
        if (validateEmail() == true & validatePassword() == true)
        {
            ...
            {
                if (userEmailLogin.value == userContainer[i].email &&
                    userPasswordLogin.value == userContainer[i].password)
                {
                    isExisted = true;
                }
            }
            ...
            {
                error.innerHTML = "✗ Incorrect email or password. Please try again.";
    ...
    {
        error.innerHTML = "✗ All fields are required. Please fill in both email and password.";
        error.classList.replace("d-none", "d-block");
    }
}
...
function validateEmail()
{
    ...
    {
        emailErrorLogin.innerHTML = "✗ Please enter a valid email (e.g., user@example.com)";
...
function validatePassword()
{
    ...
    {
        passwordErrorLogin.innerHTML = "✗ Password must be at least 8 characters long";
